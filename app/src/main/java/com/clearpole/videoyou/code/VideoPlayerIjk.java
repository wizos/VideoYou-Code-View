...
public class VideoPlayerIjk extends JZMediaInterface implements IMediaPlayer.OnPreparedListener, IMediaPlayer.OnVideoSizeChangedListener, IMediaPlayer.OnCompletionListener, IMediaPlayer.OnErrorListener, IMediaPlayer.OnInfoListener, IMediaPlayer.OnBufferingUpdateListener, IMediaPlayer.OnSeekCompleteListener, IMediaPlayer.OnTimedTextListener {
    IjkMediaPlayer ijkMediaPlayer;

    public VideoPlayerIjk(Jzvd jzvd) {
        super(jzvd);
    }
    ...
    public void prepare() {
        ...
        mMediaHandler.post(() -> {
            ...
            ijkMediaPlayer.setOnPreparedListener(VideoPlayerIjk.this);
            ijkMediaPlayer.setOnVideoSizeChangedListener(VideoPlayerIjk.this);
            ijkMediaPlayer.setOnCompletionListener(VideoPlayerIjk.this);
            ijkMediaPlayer.setOnErrorListener(VideoPlayerIjk.this);
            ijkMediaPlayer.setOnInfoListener(VideoPlayerIjk.this);
            ijkMediaPlayer.setOnBufferingUpdateListener(VideoPlayerIjk.this);
            ijkMediaPlayer.setOnSeekCompleteListener(VideoPlayerIjk.this);
            ijkMediaPlayer.setOnTimedTextListener(VideoPlayerIjk.this);
